...
dag = DAG(
    dag_id="chapter6_couponing_app_figure611",
...
copy_to_raw_supermarket_3 >> process_supermarket_3 >> create_metrics_supermarket_3
copy_to_raw_supermarket_4 >> process_supermarket_4 >> create_metrics_supermarket_4
