...
example_1_dag_2 = DAG(
    dag_id="figure_6_17_example_1_dag_2", start_date=airflow.utils.dates.days_ago(3), schedule_interval=None
)

DummyOperator(task_id="etl", dag=example_1_dag_1) >> TriggerDagRunOperator(
    task_id="trigger_dag2", trigger_dag_id="figure_6_17_example_1_dag_2", dag=example_1_dag_1
)
...
example_2_dag_4 = DAG(
    dag_id="figure_6_17_example_2_dag_4", start_date=airflow.utils.dates.days_ago(3), schedule_interval=None
)
...
example_3_dag_2 = DAG(
    dag_id="figure_6_17_example_3_dag_2", start_date=airflow.utils.dates.days_ago(3), schedule_interval=None
)
example_3_dag_3 = DAG(
    dag_id="figure_6_17_example_3_dag_3", start_date=airflow.utils.dates.days_ago(3), schedule_interval=None
)
example_3_dag_4 = DAG(
    dag_id="figure_6_17_example_3_dag_4", start_date=airflow.utils.dates.days_ago(3), schedule_interval=None
)

DummyOperator(task_id="etl", dag=example_3_dag_1) >> [
    TriggerDagRunOperator(
        task_id="trigger_dag2", trigger_dag_id="figure_6_17_example_3_dag_2", dag=example_3_dag_1
    ),
    TriggerDagRunOperator(
        task_id="trigger_dag3", trigger_dag_id="figure_6_17_example_3_dag_3", dag=example_3_dag_1
    ),
    TriggerDagRunOperator(
        task_id="trigger_dag4", trigger_dag_id="figure_6_17_example_3_dag_4", dag=example_3_dag_1
    ),
]
